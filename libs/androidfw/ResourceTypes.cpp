    ...
    if (*s == '@') {
        ...
        if (len == 5 && s[1]=='n' && s[2]=='u' && s[3]=='l' && s[4]=='l') {
            ...
            if (rid != 0) {
                ...
                if (packageId != APP_PACKAGE_ID && packageId != SYS_PACKAGE_ID && packageId != ARIEL_PACKAGE_ID) {
            ...
            if (accessor) {
                ...
                if (rid != 0) {
                    ...
                    if (packageId == 0x00) {
                        ...
                        outValue->dataType = Res_value::TYPE_DYNAMIC_REFERENCE;
                        return true;
                    } else if (packageId == APP_PACKAGE_ID || packageId == SYS_PACKAGE_ID || packageId == ARIEL_PACKAGE_ID) {
    ...
    : mAssignedPackageId(packageId)
{
    ...
    mLookupTable[ARIEL_PACKAGE_ID] = ARIEL_PACKAGE_ID;
}
